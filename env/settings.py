...
DOJO_ROOT = '/opt/django-DefectDojo/dojo'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        # 'django.db.backends.mysql','django.db.backends.sqlite3' or 'django.db.backends.oracle'.
        'NAME': 'dojodb',  # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ['13.229.154.227','127.0.0.1','localhost']
...
SECRET_KEY = 'NBfaGMuftooZfQx90CoODHUH4dLWf0Z8PhB4jwrLYpTI7lpsjlUZRTDyFISkLPWbf11MtVQbJGNMw9gse5jE56vnIGgZ9VWIDOPS3dNunVN3CLMy950MFaGjFWhlR4oS'
